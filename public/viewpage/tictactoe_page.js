...
import {addTicTacToeGameHstory, getTicTacToeGameHistory} from '../controller/firestore_controller.js';
...
async function buttonPressListner(event) {
    ...
    if (gameModel.winner != null){
        ...
        try{
            await addTicTacToeGameHstory(gamePlay);
...
async function historyButtonEvent() {
    ...
    try{
       ...
       <tr><th>Winner</th><th>Moves</th><th>Data</th>
       <body>
        `;
